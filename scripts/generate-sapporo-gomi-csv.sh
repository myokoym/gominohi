...
echo "白石区"
gominohi g shiroishi_1 $2 $3 4 >> $1/area_days.csv
gominohi g shiroishi_2 $2 $3 4 >> $1/area_days.csv
gominohi g shiroishi_3 $2 $3 4 >> $1/area_days.csv
gominohi g shiroishi_4 $2 $3 4 >> $1/area_days.csv
echo "手稲区"
...
echo "北区"
gominohi g kita_1 $2 $3 1 >> $1/area_days.csv
gominohi g kita_2 $2 $3 1 >> $1/area_days.csv
gominohi g kita_3 $2 $3 2 >> $1/area_days.csv
gominohi g kita_4 $2 $3 1 >> $1/area_days.csv
gominohi g kita_5 $2 $3 1 >> $1/area_days.csv
gominohi g kita_6 $2 $3 1 >> $1/area_days.csv
echo "南区"
gominohi g minami_1 $2 $3 3 >> $1/area_days.csv
gominohi g minami_2 $2 $3 2 >> $1/area_days.csv
gominohi g minami_3 $2 $3 2 >> $1/area_days.csv
gominohi g minami_4 $2 $3 2 >> $1/area_days.csv
