  ...
  SOURCES = [
    ...
    },
    {
      ...
      areas: [
        ...
        "清田区 里塚○条○丁目、○番地",
        "清田区 里塚緑ヶ丘○丁目",
        "清田区 美しが丘1条～3条の3丁目～10丁目（美しが丘3条3丁目1番・2番を除く）",
        "清田区 美しが丘4条・5条の○丁目",
      ],
      types: {
        :burn     => ["月", "木"],
    ...
    },
    {
      name: "higashi_2",
      areas: [
        "東区 北34条～49条の東16丁目～30丁目",
        "東区 伏古11条～14条の1丁目～5丁目",
        "東区 丘珠町○番地",
        "東区 栄町○番地",
        "東区 北丘珠○条○丁目",
      ],
    ...
    },
    {
      name: "higashi_6",
      areas: [
        "東区 北4条～14条の東8丁目～20丁目",
        "東区 北15条～33条の東16丁目～23丁目",
        "東区 苗穂町○丁目",
        "東区 本町○条○丁目",
      ],
      types: {
    ...
    },
    {
      ...
      areas: [
        "北区 新川○条○丁目、○番地",
        "北区 新川西○条○丁目",
        "北区 新琴似1条～3条の12丁目・13丁目",
        "北区 新琴似4条～10条の12丁目～17丁目",
        "北区 新琴似11条・12条の14丁目～17丁目",
        "北区 新琴似町○番地",
      ],
      types: {
        :burn     => ["月", "木"],
    ...
    },
    {
      name: "kita_3",
      areas: [
        "北区 新琴似1条～10条の1丁目～11丁目",
        "北区 新琴似11条・12条の1丁目～13丁目",
      ],
      types: {
        :burn     => ["月", "木"],
        :leaf     => [],
    ...
    },
    {
      name: "minami_1",
      areas: [
        "南区 澄川2条4丁目（12番～14番）・5丁目",
        "南区 澄川3条4丁目（7番）・5丁目・6丁目",
        "南区 澄川4条4丁目（1番18号～27号、2番～11番）・5丁目～12丁目",
        "南区 澄川5条4丁目（1番・7番～9番）・5丁目（1番～9番）",
        "南区 澄川5条6丁目（1番～8番）・7丁目～13丁目",
        "南区 澄川6条7丁目～13丁目",
        "南区 澄川○番地",
        "南区 真駒内柏丘・東町・幸町・泉町・南町の○丁目",
      ],
      types: {
        :burn     => ["月", "木"],
        :leaf     => [],
    ...
    },
    {
      name: "minami_2",
      areas: [
        "南区 石山○条○丁目、○番地（石山1条1丁目12-6パレス藻南公園を除く）",
        "南区 石山東○丁目",
        "南区 常盤○条○丁目、○番地",
        "南区 滝野○番地",
        "南区 真駒内○番地（自衛隊真駒内駐屯地を除く）",
        "南区 芸術の森○丁目",
      ],
      types: {
        :burn     => ["月", "木"],
    ...
    },
    {
      ...
      areas: [
        "南区 澄川1条1丁目～4丁目",
        "南区 澄川2条1丁目～3丁目・4丁目（1番～11番）",
        "南区 澄川3条1丁目～3丁目・4丁目（1番～6番）",
        "南区 澄川4条1丁目～3丁目・4丁目（1番1号～17号）",
        "南区 澄川5条3丁目・4丁目（2番～6番）",
        "南区 澄川5条5丁目（10番～19番）・6丁目（9番～14番）",
        "南区 澄川6条3丁目～6丁目",
        "南区 真駒内本町・曙町・上町・緑町の○丁目",
        "南区 真駒内○番地（自衛隊真駒内駐屯地のみ）",
      ],
      types: {
        :burn     => ["火", "金"],
        :leaf     => [],
    ...
    },
    {
      name: "minami_6",
      areas: [
        "南区 南沢○条○丁目、○番地（南沢1条3丁目1番（南沢やまどり公園）、20番、21番を除く）",
      ],
      types: {
        :burn     => ["火", "金"],
        :leaf     => [],
    ...
    },
    {
      ...
      areas: [
        "南区 川沿7条～18条の○丁目",
        "南区 南沢1条3丁目1番（南沢やまどり公園）、20番、21番",
        "南区 石山1条1丁目（12番6号パレス藻南公園のみ）",
      ],
      types: {
        :burn     => ["火", "金"],
        :leaf     => [],
